...
from logiClassifier.pipeline.stage_03_model_training import ModelTrainingPipeline
from logiClassifier.pipeline.stage_04_model_evaluation import EvaluationPipeline
